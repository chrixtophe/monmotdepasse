<section id="about" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-header">
        <h2>A propos du générateur de mots de passe</h2>
    </div>
    <div class="modal-body">
        <p>Le générateur de mots de passe vous permet de changer rapidement vos mots de passe lorsque vous êtes à court
        ...
        <p>J'espère que le générateur de mots de passe vous sera utile. Si vous avez des questions ou des commentaires,
        n'hésitez pas en m'en faire part, <a href="http://christophebaldy.net/contact.html" >contactez-moi</a></p>
    </div>
